...
export default function SgpAuditPage() {
  ...
  const [activeSubTab, setActiveSubTab] = useState('before'); // 'before' | 'after'
      ...
      <div style={{ display: 'flex', gap: 12, marginBottom: 30 }}>
        <button 
          ...
          style={{
            ...
            fontWeight: 600, 
            fontSize: 15,
            background: activeSubTab === 'before' ? '#2563EB' : '#F3F4F6',
            color: activeSubTab === 'before' ? '#FFFFFF' : '#6B7280', 
            cursor: 'pointer',
            boxShadow: activeSubTab === 'before' ? '0 4px 12px rgba(37,99,235,0.25)' : 'none',
            transition: 'all 0.2s',
          }}
        >
          До СР8
