...
export default function Layout() {
  ...
  const isFullScreen = location.pathname === '/report' || location.pathname === '/daily-top' || location.pathname === '/model-status' || location.pathname === '/checkpoint-map' || location.pathname === '/warranty' || location.pathname === '/tl-map' || location.pathname === '/drr-cp7-dashboard' || location.pathname === '/drr-cp8-dashboard' || location.pathname === '/drr-tl-dashboard' || location.pathname === '/drr-pip-dashboard';
